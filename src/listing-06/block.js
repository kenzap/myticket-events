...
registerBlockType( 'myticket-events/listing-06', {
	...
	attributes: {
        ...
        img1: {
            type: 'string',
            default: window.kenzap_myticket_path + "assets/location.svg",
        },
		order: {
			type: 'string',
			default: ''
	...
	edit: function( props ) {
		...
		if ( props.attributes.preview ) return ( <img src={ `${ window.kenzap_myticket_path + 'assets/block_preview-06.jpg' }` } /> );
