...
if ( empty($kenzapSize) ) $kenzapSize = 'kenzap-lg';
if ( $attributes['serverSide'] ){

	?><img src="<?php echo MYTICKET_URL . 'assets/block_preview-02.jpg'; ?>" alt="<?php echo esc_attr__('block preview', 'myticket-events'); ?>" />
				...
				if ( $attributes['checkFilter'] ) : ?>
					...
					<?php if ( count($states) ) {  
						...
						foreach ( $states as $state ) { 
							...
							if ( !in_array($monthyear, $monthsyears, true) ){
