...
add_action('wp_ajax_nopriv_myticket_filter_list_ajax2', 'myticket_events_filter_list_ajax2');
add_action('wp_ajax_myticket_filter_list_ajax2', 'myticket_events_filter_list_ajax2');
if ( ! function_exists( 'myticket_events_filter_list_ajax2' ) ) {
    function myticket_events_filter_list_ajax2() {
        global $woocommerce;
        ...
        $kenzapSize               = (isset($_POST['sizes'])) ? sanitize_text_field($_POST['sizes']) : 'kenzap-lg';
        $maxwidth                 = (isset($_POST['maxwidth'])) ? sanitize_text_field($_POST['maxwidth']) : '1170';
        ...
        $myticket_args = array(
            'posts_per_page' => ($events_per_page==""?100:$events_per_page),
